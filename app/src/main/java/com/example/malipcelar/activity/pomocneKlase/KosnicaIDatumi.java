...
public class KosnicaIDatumi {
    ...
    public String getMaxDatumPregleda() {
        return maxDatumPregleda;
    }

    public void setMaxDatumPregleda(String maxDatumPregleda) {
        this.maxDatumPregleda = maxDatumPregleda;
    }
